        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>User Webpage</span></a>
            </div>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-bar-chart-o"></i> Fuzzy TOPSIS <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="chartjs.html">Edit Fuzzy Assessment Ratings</a></li>
                      <li><a href="chartjs2.html">Edit Fuzzy Weightings</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
              <!-- sampe sini sidebarnya -->
              <div class="menu_section">
                <h3>Live On</h3>
                <ul class="nav side-menu">
