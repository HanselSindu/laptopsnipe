  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Laptop Scores <small>Input The Scores for Laptops here</small></h3>
              </div>
            ...
            <div class="col-md-5 col-sm-5 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Input Laptop Review<small>for scoring the laptops</small></h2>
                    ...
                    <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                      ...
                      <tbody>
                        ...
                        <?php
                          ...
                          $prod = (string)$row->product_name;
                        ?>
                        <td><a onclick="reviewProduct('<?php echo $id ?>', '<?php echo $brand ?>', '<?php echo $prod ?>')" class="btn btn-dark">Review</a></td>
                        </tr>
                        <?php endforeach; ?>
                      </tbody>
                    </table>
              ...
              <div class="col-md-7 col-sm-7 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form id="ReviewInput" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo base_url()?>admin/Form/inputScore">
                    <?php echo form_hidden($this->security->get_csrf_token_name(), $this->security->get_csrf_hash());?>
                      ...
                      <div class="form-group">
                        <label for="prod-name" class="control-label col-md-3 col-sm-3 col-xs-12">Product Name<span class="required"></span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="prod-name" disabled="disabled" selected="selected" required="required" class="form-control col-md-7 col-xs-12" type="text" name="prod-name" value="">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <?php 
                            ...
                            echo '<option value="'.$row->id_fuzzyassess.'">'.$row->linguistic_var_a.'</option>';
                            }?>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label for="id-prod" class="control-label col-md-3 col-sm-3 col-xs-12"><span class="required"></span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="id-prod" required="required" class="form-control col-md-7 col-xs-12" type="hidden" name="id-prod" value="">
                        </div>
                      </div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button class="btn btn-dark" type="button">Cancel</button>
                          <button id='submit-score' disabled='true' type="submit" class="btn btn-dark">Submit</button>
                        </div>
                      </div>
                </form>
                  </div>
            ...
            <div class="">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Laptop <small>Reviews</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li class="dropdown">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <td><?php echo $row->username;?></td>
    										<td><?php echo $row->brand_name; echo " "; echo $row->product_name;?></td>
    										<td><?php echo $row->cpu_performance;?></td>
        								<td><?php echo $row->gpu_performance;?></td>
        								<td><?php echo $row->battery_life;?></td>
        								<td><?php echo $row->audio_quality;?></td>
        								<td><?php echo $row->keyboard_quality;?></td>
        								<td><?php echo $row->wifi;?></td>
        								<td><?php echo $row->durability;?></td>
        								<td><?php echo $row->warranty;?></td>
        								<td><?php echo $row->cooling_systems;?></td>
    										</tr>
												<?php endforeach; ?>
                      </tbody>
                    </table>
        ...
        <!-- Javascript -->
            <script>
              function reviewProduct(id, brandname, productname){

                var divelement = document.getElementById('prod-name');
                var divelement1 = document.getElementById('id-prod');
                
                divelement.value=brandname+ " " +productname;
